...
public class CzekoladowyKociol2 {
    private static CzekoladowyKociol2 instance = new CzekoladowyKociol2();
    private boolean pusty;
    private boolean ugotowany;

    public static synchronized CzekoladowyKociol2 getInstance(){return instance;}

    private CzekoladowyKociol2() {
        pusty = true;
        ugotowany = false;
